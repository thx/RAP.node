...
function BlueprintAdapter(rapActionModel) {
    this.data = rapActionModel;
}

BlueprintAdapter.prototype = Object.create(new BaseAdapter());

BlueprintAdapter.prototype.getBlueprintText = function() {
    var a = [];
    var d = this.data;
...
function _blueprintAdaperTest() {
    var adapter = new BlueprintAdapter(_getMockData());
    console.log(adapter.getBlueprintText());
}
...
function _getMockData() {
    return {
        ...
        "description": "获取报表数据",
        "requestType": "1",
        "requestUrl": "/snsADGroup/listSNSADGroup.htm",
        "responseTemplate": "",
        /**
         * 请求参数列表
         */
